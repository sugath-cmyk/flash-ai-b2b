...
export const INGREDIENTS_DATABASE: Record<string, IngredientData> = {
  ...
  // === AYURVEDIC & TRADITIONAL INDIAN INGREDIENTS ===
  'turmeric': {
    name: 'Turmeric',
    aliases: ['haldi', 'curcumin', 'curcuma longa'],
    category: 'brightening',
    benefits: ['brightening', 'anti-inflammatory', 'antibacterial', 'antioxidant'],
    concerns: ['pigmentation', 'acne', 'uneven_tone', 'inflammation'],
    skinTypes: ['normal', 'oily', 'combination'],
    concentration: { min: 0.5, max: 5, optimal: 2 },
    ph: { min: 5, max: 7 },
    timeOfUse: 'evening',
    ...
    pregnancySafe: true,
    sensitivityRisk: 'medium',
    synergies: ['sandalwood', 'honey', 'besan'],
    conflicts: [],
    ageRange: { min: 14, max: 90 }
  },
  'neem': {
    name: 'Neem',
    aliases: ['nimba', 'azadirachta indica', 'margosa'],
    category: 'antibacterial',
    benefits: ['antibacterial', 'antifungal', 'oil-control', 'anti-acne'],
    concerns: ['acne', 'oily_skin', 'fungal_acne', 'breakouts'],
    ...
    pregnancySafe: false,
    sensitivityRisk: 'low',
    synergies: ['tulsi', 'tea_tree'],
    conflicts: [],
    ageRange: { min: 12, max: 80 }
  },
  'sandalwood': {
    name: 'Sandalwood',
    aliases: ['chandan', 'santalum album'],
    category: 'soothing',
    benefits: ['cooling', 'brightening', 'soothing', 'anti-inflammatory'],
    concerns: ['pigmentation', 'redness', 'irritation', 'heat_rash'],
    skinTypes: ['all'],
    concentration: { min: 1, max: 10, optimal: 3 },
    ph: { min: 5, max: 7 },
    timeOfUse: 'both',
    ...
    pregnancySafe: true,
    sensitivityRisk: 'low',
    synergies: ['rose', 'turmeric', 'saffron'],
    conflicts: [],
    ageRange: { min: 0, max: 100 }
  },
  'saffron': {
    name: 'Saffron',
    aliases: ['kesar', 'kumkum', 'crocus sativus'],
    category: 'brightening',
    benefits: ['brightening', 'radiance', 'anti-aging', 'complexion enhancing'],
    concerns: ['dullness', 'pigmentation', 'uneven_tone', 'aging'],
    skinTypes: ['all'],
    concentration: { min: 0.1, max: 2, optimal: 0.5 },
    ph: { min: 5, max: 7 },
    timeOfUse: 'both',
    ...
    pregnancySafe: true,
    sensitivityRisk: 'low',
    synergies: ['sandalwood', 'milk', 'honey'],
    conflicts: [],
    ageRange: { min: 14, max: 100 }
  },
  'kumkumadi': {
    name: 'Kumkumadi Tailam',
    aliases: ['kumkumadi', 'kumkumadi oil', 'saffron oil blend'],
    category: 'anti-aging',
    benefits: ['brightening', 'anti-aging', 'radiance', 'complexion enhancing'],
    concerns: ['pigmentation', 'dullness', 'fine_lines', 'uneven_tone'],
    skinTypes: ['normal', 'dry', 'combination'],
    concentration: { min: 100, max: 100, optimal: 100 },
    ph: { min: 5, max: 7 },
    timeOfUse: 'evening',
    photosensitive: true,
    pregnancySafe: true,
    sensitivityRisk: 'low',
    synergies: ['rose_water', 'sandalwood'],
    conflicts: ['retinol'],
    ageRange: { min: 18, max: 100 }
  },
  'rose_water': {
    name: 'Rose Water',
    aliases: ['gulab jal', 'rosa damascena'],
    category: 'soothing',
    benefits: ['hydrating', 'toning', 'soothing', 'refreshing'],
    concerns: ['dryness', 'sensitivity', 'redness'],
    skinTypes: ['all'],
    concentration: { min: 50, max: 100, optimal: 100 },
    ph: { min: 4.5, max: 6 },
    timeOfUse: 'both',
    photosensitive: false,
    pregnancySafe: true,
    sensitivityRisk: 'low',
    synergies: ['glycerin', 'aloe_vera', 'sandalwood'],
    conflicts: [],
    ageRange: { min: 0, max: 100 }
  },
  'multani_mitti': {
    name: 'Multani Mitti',
    aliases: ['fullers earth', 'kaolin', 'bentonite clay'],
    category: 'oil-control',
    benefits: ['oil-absorbing', 'pore-cleansing', 'detoxifying'],
    concerns: ['oily_skin', 'enlarged_pores', 'blackheads', 'acne'],
    ...
    pregnancySafe: true,
    sensitivityRisk: 'medium',
    synergies: ['rose_water', 'neem', 'turmeric'],
    conflicts: [],
    ageRange: { min: 12, max: 70 }
  },
  'manjistha': {
    name: 'Manjistha',
    aliases: ['rubia cordifolia', 'indian madder'],
    category: 'brightening',
    benefits: ['blood-purifying', 'brightening', 'anti-inflammatory'],
    concerns: ['pigmentation', 'acne_scars', 'uneven_tone'],
    skinTypes: ['all'],
    concentration: { min: 1, max: 5, optimal: 2 },
    ph: { min: 5, max: 7 },
    timeOfUse: 'both',
    ...
    pregnancySafe: false,
    sensitivityRisk: 'low',
    synergies: ['licorice', 'turmeric'],
    conflicts: [],
    ageRange: { min: 16, max: 80 }
  },
  'ashwagandha': {
    name: 'Ashwagandha',
    aliases: ['withania somnifera', 'indian ginseng'],
    category: 'anti-aging',
    benefits: ['anti-stress', 'anti-aging', 'firming', 'antioxidant'],
    concerns: ['dullness', 'aging', 'stress_related_skin'],
    skinTypes: ['all'],
    concentration: { min: 0.5, max: 5, optimal: 2 },
    ph: { min: 5, max: 7 },
    timeOfUse: 'evening',
    ...
    pregnancySafe: false,
    sensitivityRisk: 'low',
    synergies: ['saffron', 'ghee'],
    conflicts: [],
    ageRange: { min: 25, max: 90 }
  },
  'licorice_root': {
    name: 'Licorice Root',
    aliases: ['mulethi', 'yashtimadhu', 'glycyrrhiza glabra'],
    category: 'brightening',
    benefits: ['brightening', 'soothing', 'anti-inflammatory', 'pigmentation reduction'],
    concerns: ['pigmentation', 'dark_spots', 'sensitivity', 'redness'],
    skinTypes: ['all'],
    concentration: { min: 0.5, max: 5, optimal: 2 },
    ph: { min: 5, max: 7 },
    timeOfUse: 'both',
  ...
  'tulsi': {
    name: 'Tulsi',
    aliases: ['holy basil', 'ocimum sanctum', 'ocimum tenuiflorum'],
    category: 'antibacterial',
    benefits: ['antibacterial', 'purifying', 'antioxidant', 'anti-pollution'],
    concerns: ['acne', 'pollution', 'oily_skin'],
    skinTypes: ['oily', 'combination', 'acne-prone'],
    concentration: { min: 0.5, max: 5, optimal: 2 },
    ph: { min: 5, max: 7 },
    timeOfUse: 'both',
    ...
    pregnancySafe: false,
    sensitivityRisk: 'low',
    synergies: ['neem', 'turmeric'],
    conflicts: [],
    ageRange: { min: 12, max: 80 }
  },
  'amla': {
    name: 'Amla',
    aliases: ['indian gooseberry', 'amalaki', 'phyllanthus emblica'],
    category: 'antioxidant',
    benefits: ['vitamin-c rich', 'brightening', 'anti-aging', 'collagen boosting'],
    concerns: ['dullness', 'aging', 'pigmentation'],
    skinTypes: ['all'],
    concentration: { min: 0.5, max: 5, optimal: 2 },
    ph: { min: 3, max: 5 },
    timeOfUse: 'both',
    ...
    pregnancySafe: true,
    sensitivityRisk: 'low',
    synergies: ['vitamin_e', 'honey'],
    conflicts: [],
    ageRange: { min: 14, max: 90 }
  },
  'brahmi': {
    name: 'Brahmi',
    aliases: ['bacopa monnieri', 'water hyssop'],
    category: 'soothing',
    benefits: ['soothing', 'healing', 'anti-inflammatory', 'wound healing'],
    concerns: ['sensitivity', 'wound_healing', 'irritation'],
    skinTypes: ['sensitive', 'all'],
    concentration: { min: 0.5, max: 5, optimal: 2 },
    ph: { min: 5, max: 7 },
    timeOfUse: 'both',
    ...
    pregnancySafe: false,
    sensitivityRisk: 'low',
    synergies: ['centella', 'aloe_vera'],
    conflicts: [],
    ageRange: { min: 0, max: 100 }
  },
  'vetiver': {
    name: 'Vetiver',
    aliases: ['khus', 'vetiveria zizanioides'],
    category: 'soothing',
    benefits: ['cooling', 'soothing', 'oil-control', 'refreshing'],
    concerns: ['oily_skin', 'heat_rash', 'redness'],
  ...
  'coconut_oil': {
    ...
    benefits: ['moisturizing', 'antibacterial', 'nourishing'],
    concerns: ['dryness', 'dry_skin'],
  ...
  'almond_oil': {
    ...
    aliases: ['badam tel', 'prunus amygdalus dulcis'],
    category: 'moisturizing',
    benefits: ['nourishing', 'dark circle reduction', 'moisturizing'],
    concerns: ['dark_circles', 'dryness', 'fine_lines'],
    ...
    pregnancySafe: true,
    sensitivityRisk: 'low',
    synergies: ['vitamin_e', 'rose_water'],
    conflicts: [],
    ageRange: { min: 0, max: 100 }
  },
  'besan': {
    name: 'Besan',
    aliases: ['gram flour', 'chickpea flour'],
    category: 'exfoliant',
    benefits: ['gentle exfoliation', 'brightening', 'oil-absorbing'],
    concerns: ['dullness', 'oily_skin', 'uneven_texture'],
    skinTypes: ['all'],
    concentration: { min: 100, max: 100, optimal: 100 },
    ph: { min: 6, max: 7 },
    timeOfUse: 'evening',
